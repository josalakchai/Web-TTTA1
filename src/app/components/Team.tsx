...
const mentors = [
  ...
  {
    name: 'Warit Jarujit (ปั้น)',
    title: 'DevOps Engineer',
    image: '/006.png',
    quote: "Great engineers don't just write code—they solve problems that matter.",
  },
  {
    name: 'Supadol Kudmo (เกม)',
    title: 'Frontend Developer',
    image: '/007.png',
    quote: "Great engineers don't just write code—they solve problems that matter.",
  },
  {
    name: 'Gangrao Sontad (หาญ)',
    title: 'IoT Engineer',
    image: '/009.png',
    quote: "Great engineers don't just write code—they solve problems that matter.",
  },
  {
    name: 'Pongsagorn Chumnankul (พิชโช่)',
    title: 'Data Engineer',
    image: '/005.png',
    quote: "Great engineers don't just write code—they solve problems that matter.",
  },
  {
    name: 'Panat Phongphaew (ปาล์ม)',
    title: 'Junior Full-Stack Developer',
    image: '/010.png',
    quote: "Great engineers don't just write code—they solve problems that matter.",
  },
  {
    name: 'Pitchita Chumnankul (พิม)',
    title: 'CAD Designer',
    image: '/.png',
    quote: "Great engineers don't just write code—they solve problems that matter.",
  },
  {
    name: 'Sitthisak Phisanphiphak (โอ)',
    title: 'Junior Backend Developer',
    image: '/012.png',
    quote: "Great engineers don't just write code—they solve problems that matter.",
  },
  {
    name: 'Elena Martinez (เอย)',
    title: 'Full-stack Developer',
    image: '/013.png',
    quote: "Great engineers don't just write code—they solve problems that matter.",
  },
  {
    name: 'Salukchai Saetho (โจ)',
  ...
  {
    name: 'Elena Martinez (หลิว)',
    title: 'Full-stack Developer',
    image: '/011.png',
    quote: "Great engineers don't just write code—they solve problems that matter.",
  },
  {
    name: 'Elena Martinez (ใหม่)',
    title: 'Full-stack Developer',
    image: '/008.png',
    quote: "Great engineers don't just write code—they solve problems that matter.",
  },
